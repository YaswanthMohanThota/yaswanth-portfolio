...
const projects = [
  {
    ...
    previewType: 'video',
    previewSrc: `${base}projects/rgb-mocap1.mp4`,
  ...
  },
  {
    ...
    previewType: 'video',
    previewSrc: `${base}projects/collab-transport1.mp4`,
  ...
  },
  {
    ...
    previewType: 'video',
    previewSrc: `${base}projects/dream-lab2.mp4`,
    previewPosition: '50% 70%',
    post: 'https://www.linkedin.com/posts/venkata-sai-thota_universityatbuffalo-robotics-dreamabrlab-ugcPost-7425722389415510018-3QI7?utm_source=share&utm_medium=member_desktop&rcm=ACoAACWSgiUBSRWe_yKKmBiKk8LXkZfzzb9iKQg',
            ...
            {visualItems.length > 0 && (
              <div className="modal-grid-row modal-grid-row-visual">
                {visualItems.map((item) => (
                  <div key={item.label} className="modal-grid-item modal-grid-item-cover">
                    <img
                      src={item.src}
                      alt={item.label}
            ...
            {resultItems.length > 0 && (
              <div className="modal-grid-row modal-grid-row-results">
                {resultItems.map((item) => (
                  <div key={item.label} className="modal-grid-item modal-grid-item-cover modal-grid-item-results">
                    <img
                      src={item.src}
                      alt={item.label}
                      style={{ objectPosition: item.position || '50% 50%' }}
